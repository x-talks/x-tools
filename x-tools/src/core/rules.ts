...
export const PRINCIPLE_TEMPLATES = [
    "Data as a Product",
    ...
    "Sustainable Pace",
    "InnerSource",
    "Disruptive Innovation (Moonshots)",
    "Product-Led Growth (PLG)",
    "Pivot Speed (Optionality)",
...
// Value Library (v1.1)
export const VALUE_LIBRARY = [
    "Safety", "Security", "Reliability", "Speed", "Quality", "Excellence", "Trust", "Honesty", "Transparency", "Integrity",
    "Collaboration", "Openness", "Inclusivity", "Respect", "Empathy", "Innovation", "Creativity", "Curiosity", "Learning",
    "Customer Obsession", "User Centricity", "Service", "Ownership", "Accountability", "Bias for Action", "Sustainability",
    "Impact", "Growth", "Adaptability", "Resilience", "Courage", "Experimentation", "Engineering Excellence", "Knowledge Sharing",
    "Continuous Improvement", "Responsiveness", "Agility", "Teamwork", "Communication", "Leadership", "Problem Solving",
    "Data-Driven", "Digital Fluency", "Vision", "Strategy", "Mentorship", "Coaching", "Empowerment", "Culture Building", "Networking",
    "Decision-Making", "Ethics", "Diversity", "Equity", "Inclusion", "Performance", "Optimization", "Scaling", "Transformation",
    "Innovation Mindset", "Creativity Focus", "Customer Empathy", "Feedback Orientation", "Collaboration Excellence", "Trustworthiness",
    "Transparency Mindset", "Ownership Culture", "Sustainability Awareness", "Risk Awareness", "Technical Mastery", "Adaptability Mindset",
    "Continuous Learning", "Outcome Focus", "Value Creation", "Experimentation Mindset", "Responsibility", "Commitment"
];

// Behavior Library (v1.1)
...
// Principle Library (v1.1)
export const PRINCIPLE_LIBRARY = [
    "Data as a Product",
    "Shift-Left Data Quality",
    "Federated Computational Governance",
    "Ethical AI by Design",
